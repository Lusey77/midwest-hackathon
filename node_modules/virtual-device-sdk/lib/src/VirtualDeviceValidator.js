...
var Validator = (function () {
    ...
    Validator.checkString = function (property, value, expected) {
        if (!expected) {
            return undefined;
        }
        if (!value) {
    ...
    Validator.prototype.check = function () {
        ...
        var transcriptError = Validator.checkString("transcript", this.resultItem.actual.transcript, this.resultItem.test.expected.transcript);
